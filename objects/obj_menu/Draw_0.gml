draw_sprite_streched(spr_box, 0, x, y, widthFull, heightFull)
...
draw_sprite(spr_point, 0, x + xmargin + 8, y + ymargin + ((hover - _scrollPush) * heightLine) + 7);
if (visibleOptionsMax < array_length(options)) && (hover < array_length(options)-1)
{
	draw_sprite(spr_point, 0, x + widthFull * 0.5, y + heightFull - 7)
}